...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-zinc-800 p-4">
      <div className="bg-white dark:bg-zinc-900 p-8 rounded-lg shadow-md w-full max-w-md space-y-6 text-center">
        ...
        >
          ...
          >
            ...
            <path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 
              ...
              4.93l2.85-2.22.81-.62z" fill="#FBBC05"/>
